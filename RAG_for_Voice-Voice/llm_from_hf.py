...
generator = pipeline("text-generation", model="meta-llama/Llama-3.2-1B-Instruct", max_new_tokens=1024, model_kwargs={"ignore_mismatched_sizes": True})
hf_model = HuggingFacePipeline(pipeline=generator)
